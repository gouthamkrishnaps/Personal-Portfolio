...
function Home() {
  ...
  return (
    <div className='container-fluid' style={{backgroundColor:"black"}}>
        ...
        <div className="row">
          <div className="name-div col-lg-6 col-sm-12 d-flex flex-column justify-content-center align-items-center">
            <div className='text-box'>
              ...
              <h1 className='fw-bold' style={{color:"red"}}>I'm Goutham Krishna</h1>
              <div className='mt-5'>
                <h1 className='line-1 anim-typewriter fw-bold'>MERN STACK Developer</h1>
              </div>
              <div>
                <button className='btn btn-outline-danger mt-2 rounded-pill'>Know More</button>
              </div>
            </div>
          </div>
          <div className="img-div col-lg-6 col-sm-12 d-flex flex-column justify-content-center align-items-center">
             <button className='resume-btn fw-bold border border-light'> Download Resume  <i class="fa-solid fa-download"></i></button>
          </div>
        </div>
      </div>
      <section>
      <div id='about' className='about-page'>
        <div className='d-flex flex-column justify-content-center align-items-center' >
          ...
          <div className='profile-img'>
            <img className='rounded-circle' src={Img1} alt="" width={"150px"}/>
          </div>
          <div className="row">
      ...
      <div id='services' className='services'>
        ...
        <div className="row mt-5">
          ...
          <div className="col-lg-10 col-md-12">
            <div className="row">
              <div className="col-lg-3 col-md-6 col-sm-12 p-3 service-card">
                <div className=' card-effect'>
                  <h4 className='text-center fw-bold'>Full stack Developer</h4>
              ...
              <div className="col-lg-3 col-md-6  col-sm-12 p-3 service-card">
                <div className=' card-effect'>
                  <h4 className='text-center fw-bold'>Web Designer</h4>
                  <p className='mt-3' style={{textAlign:"justify"}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga expedita delectus sapiente eius sint numquam, qui fugiat asperiores est optio fugit id at eligendi nulla quasi cumque nam aspernatur soluta?</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6  col-sm-12 p-3 service-card">
                <div className=' card-effect'>
                  <h4 className='text-center fw-bold'>Front-end Developer</h4>
                  <p className='mt-3' style={{textAlign:"justify"}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga expedita delectus sapiente eius sint numquam, qui fugiat asperiores est optio fugit id at eligendi nulla quasi cumque nam aspernatur soluta?</p>
                </div>
              </div>
              <div className="col-lg-3 col-md-6  col-sm-12 p-3">
                <div className=' card-effect'>
                  <h4 className='text-center fw-bold'>Back-end Developer</h4>
                  <p className='mt-3' style={{textAlign:"justify"}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Fuga expedita delectus sapiente eius sint numquam, qui fugiat asperiores est optio fugit id at eligendi nulla quasi cumque nam aspernatur soluta?</p>
                </div>
              </div>
            </div>
      ...
      <div id='projects' className='projects about-page'>
      ...
      <div id='contact' className='contact about-page d-flex flex-column justify-content-center align-items-center'>
        ...
        <div className="form w-100 mt-5 ">
          ...
          <div className="row">
            ...
            <form ref={form} onSubmit={sendEmail} className='w-100'>
              ...
              <button className='btn btn-success rounded mt-3' type="submit">Send Email  <i class="fi fi-br-paper-plane-top"></i></button>
            </form>
            </div>
            <div className="col-lg-3 col-md-3 col-sm-0"></div>
          </div>
